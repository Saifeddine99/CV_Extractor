...
from src.pdf_processing.image_extraction import extract_text_from_image_pdf_html
...
# Paths to folders
pdf_folder = "data/labeled_pdfs/image_based"
...
with col12:
    st.header("Extracted HTML Tesseract OCR")
    st.write("###")

    try:
        extracted_html = extract_text_from_image_pdf_html(selected_pdf_path)
